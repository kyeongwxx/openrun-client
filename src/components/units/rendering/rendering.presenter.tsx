  ...
  return (
    <s.Wrapper>
      <s.EventWrapper>
        ...
        <s.Box2>
          <s.TextBox>
            <s.TextBig>1:1 매칭 러너를 찾아보세요</s.TextBig>
            {/* <s.TextSmall>
              오픈런은 당신의 소중한 시간과 아이템을 지켜드립니다. 바쁜 일상
              속에서도 소중한 아이템을 놓칠 수 없는 당신을 위해서 오픈러너를
              모집하고 성공률을 확인한 후에 러너를 채택해보세요.
            </s.TextSmall> */}
          </s.TextBox>
          <s.ImgInfoBox>
        ...
        <s.Box3>
          <s.Box3Wrapper>
            <s.TextBox>
              <s.TextBig>채팅을 통해 러너와 대화해보세요</s.TextBig>
              {/* <s.TextSmall>
        ...
        <s.Box4>
          <s.TextBox>
            <s.TextBig>고객님들의 후기를 들어보세요</s.TextBig>
            <s.TextSmall>
              고객님들의 생생한 실제 사용 후기 입니다. 더 많은 사용 후기를
              구경하러 오세요. 득템할 수 있는 기회를 오픈런을 통해서 잡으세요.
            </s.TextSmall>
          </s.TextBox>
