  ...
  return (
    <s.Wrapper>
      ...
      <s.WithItemWrapper>
        ...
        <s.WithItemSubTitle>함께 보면 좋은 제품</s.WithItemSubTitle>
        <s.WithItemBox>
          <s.WithItemImg src="/img/Rectangle 38.png" />
          <s.WithItemImg src="/img/Rectangle 39.png" />
          <s.WithItemImg src="/img/Rectangle 40.png" />
          <s.WithItemImg src="/img/Rectangle 47.png" />
